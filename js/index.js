...
function active()
{
	var posting = $.post("https://ssl14.ovh.net/~taxibleu/client/active_app.php", { tel: tel, dep: '13'}, function(data) {
...
function secureCall(position)
{
	...
	$.post("https://ssl14.ovh.net/~taxibleu/client/secure_xml.php", { lat: lat, lng: lng, dep: '13', pass: 'true'}, function(xml){
		...
		$(xml).find('marker').each(function(){
			...
			$.post("https://ssl14.ovh.net/~taxibleu/client/secure.php", { taxi: name, tel: address, rdvpoint: rdvpoint, helptaxi: taxi, helpname: helpname, helptel: tel, idcourse: idcourseUrg, num_req: num_reqUrg, dep: '13', pass: 'true'}, function(data){
...
{
	var idcourseUrg = $.sessionStorage.getItem('idcourseUrg');
	$.post("https://ssl14.ovh.net/~taxibleu/client/secure.php", { taxi: '', tel: '', rdvpoint: '', helptaxi: taxi, helpname: '', helptel: tel, idcourse: idcourseUrg, dep: '13', pass: 'true', stopcall: 'true'}, function(data){
